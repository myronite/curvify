...
data class G2Continuity(
    ...
    override fun createStandardRoundedRectanglePathSegments(
        ...
        val extFracTL = com.myronite.curvify.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioTL)
        val extFracTR = com.myronite.curvify.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioTR)
        val extFracBR = com.myronite.curvify.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioBR)
        val extFracBL = com.myronite.curvify.lerp(capsuleProfile.extendedFraction, profile.extendedFraction, ratioBL)
        ...
        val bezKScaleTLV =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTLV)
        val bezKScaleTLH =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTLH)
        val bezKScaleTRH =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTRH)
        val bezKScaleTRV =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioTRV)
        val bezKScaleBRV =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBRV)
        val bezKScaleBRH =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBRH)
        val bezKScaleBLH =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBLH)
        val bezKScaleBLV =
            com.myronite.curvify.lerp(capsuleProfile.bezierCurvatureScale, profile.bezierCurvatureScale, ratioBLV)

        // arc stuffs

        // arc fractions of each corner
        val arcFracTL = com.myronite.curvify.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioTL)
        val arcFracTR = com.myronite.curvify.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioTR)
        val arcFracBR = com.myronite.curvify.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioBR)
        val arcFracBL = com.myronite.curvify.lerp(capsuleProfile.arcFraction, profile.arcFraction, ratioBL)
